...
@Entity
@Table(name = "TIT_TIPO_TITULO")
@SequenceGenerator(name = "TIT_TIPO_TITULO_GENERATOR", sequenceName = "SEQ_TIT_TIPO_TITULO", allocationSize = 1)
public class TitTipoTitulo {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TIT_TIPO_TITULO_GENERATOR")
	@Column(name = "COD_TIPO_TITULO", nullable = false)
	private Long codTipoTitulo;

	@Size(max = 100)
	@Column(name = "NOM_TIPO_TITULO", length = 100)
	private String nomTipoTitulo;
	...
	public String getNomTipoTitulo() {
		return nomTipoTitulo;
	}

	public void setNomTipoTitulo(String nomTipoTitulo) {
		this.nomTipoTitulo = nomTipoTitulo;
	}
